...
public class Application {
	...
	private static void combineSchemas() {
		...
		for (String fileName : fileNames) {
			...
			try {
				reader = new BufferedReader(new InputStreamReader(new FileInputStream(Objects.requireNonNull(Application.class.getResource("xsd/"+fileName)).getFile())));
		...
		File ops = new File(Objects.requireNonNull(Application.class.getResource("xsd/operations.xsd")).getFile());
		try {
