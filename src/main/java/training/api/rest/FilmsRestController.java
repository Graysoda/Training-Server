...
public class FilmsRestController {
    ...
    public ResponseEntity<?> createFilm(@RequestBody FilmJson filmJson){
        ...
        if (StringUtils.isNotEmpty(filmJson.getTitle()) && Common.isStringSafe(filmJson.getTitle()))
            request.setTitle(filmJson.getTitle());
        else
            return ResponseEntity.badRequest().body("Film title cannot be null or empty or contain \',\",\\,;");

        if (StringUtils.isNotEmpty(filmJson.getDescription()) && Common.isStringSafe(filmJson.getDescription()))
            request.setDescription(filmJson.getDescription());
        else
            return ResponseEntity.badRequest().body(Common.stringFailureMessage("Film description"));

        if (StringUtils.isNotEmpty(filmJson.getLanguage()) && Common.isStringSafe(filmJson.getLanguage()))
            request.setLanguage(filmJson.getLanguage());
        else
            return ResponseEntity.badRequest().body(Common.stringFailureMessage("Film language"));
        ...
        if (StringUtils.isNotEmpty(filmJson.getOriginalLanguage()) && Common.isStringSafe(filmJson.getOriginalLanguage()))
        ...
        if (filmJson.getSpecialFeatures() != null && Common.isStringSafe(filmJson.getSpecialFeatures()))
            request.setSpecialFeatures(filmJson.getSpecialFeatures());
        else
            return ResponseEntity.badRequest().body(Common.stringFailureMessage("Film specialFeatures"));

        if (StringUtils.isNotEmpty(filmJson.getCategory()) && Common.isStringSafe(filmJson.getCategory()))
